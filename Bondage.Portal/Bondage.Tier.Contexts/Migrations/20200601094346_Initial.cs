        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Effort_ApplicationUser_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Break_Effort_EffortId",
                        column: x => x.EffortId,
                        principalTable: "Effort",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Break_Kind_KindId",
                        column: x => x.KindId,
                        principalTable: "Kind",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Break_EffortId",
                table: "Break",
                column: "EffortId");

            migrationBuilder.CreateIndex(
                name: "IX_Break_KindId",
                table: "Break",
                column: "KindId");

            migrationBuilder.CreateIndex(
                name: "IX_Effort_ApplicationUserId",
                table: "Effort",
